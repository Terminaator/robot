...
cv2.createTrackbar("1", "Trackbars", 71, 255, nothing)
cv2.createTrackbar("2", "Trackbars", 155, 255, nothing)
cv2.createTrackbar("3", "Trackbars", 102, 255, nothing)
...
while True:
    ...
    cv2.imwrite(str(currentPic) + ".png", frame)
    currentPic += 1
